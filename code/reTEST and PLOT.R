...
col <- merge_set$date
for(i in 1:3){
  plot(col[c(23:length(col))], vol_data[[i]], type="l", xlab = "", ylab = "", main = colnames(vol_data[i]),
       col = rgb(153/255, 0, 0, 0.5), font.main = 2, lwd=0.5)
  grid(NA, NULL,lty = 2)
  lines(x = col[c(23:length(col))], y= vol_data[[i]], type = "l",  col = rgb(153/255, 0, 0, 0.5), lwd = 1)
}
...
png("/Users/82108/Desktop/q99_50.png", width = 2000, height = 1500, res = 500)
